...
Ao iniciar a raspagem será apresentado uma barra de progresso da raspagem e ao finalizar o processo os dados serão salvos no diretório `output/` na raiz do projeto.
