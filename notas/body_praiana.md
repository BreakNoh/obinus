...
provider=jet-engine/result2

**IMPORTANTE** parece que dita a linha, deve ir de 0 a 100?
query[_tax_query_linhas]=21

**IMPORTANTE** parece dizer quantos resultados retornara, 10 deve ser o suficiente
defaults[posts_per_page]=10

defaults[post_status][]=publish
defaults[post_type]=linhas
defaults[paged]=1
defaults[ignore_sticky_posts]=1
settings[lisitng_id]=250
settings[columns]=3
